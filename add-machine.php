    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form method="POST" action="assets/backend/controller.php?act=addMachine">
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Delay <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="delay">
                                    </div>
                                </div>
                                <div class="col-sm-6 form-group" style="margin-top: 10px;">
                                    <label class="display-block">Machine Status <span class="text-danger">*</span></label>
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn">Create Machine</button>
                            </div>
                        </form>
                    </div>
                </div>
