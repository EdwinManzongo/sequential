            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-machine.php" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i> Add Machine</a>
                    </div>
                </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo rand(1,50) . "hrs"; ?></td>
                                            <td><span class="custom-badge status-green"><?php echo $row['status']; ?></span></td>
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action">
                                                    <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="edit-machine.php?machineid=<?php echo $row["id"]; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
